...
func (ovn *SyncHandler) setupOvnClusterRouterLRPs() error {
	...
	err := ovn.reconcileSubOvnLogicalRouterPolicies(remoteSubnets)
	if err != nil {
		return err
	}
...
func (ovn *SyncHandler) updateSubmarinerRouterRemoteRoutes() error {
	...
	err := ovn.reconcileSubOvnLogicalRouterStaticRoutes(submarinerUpstreamRPort, HostUpstreamIP, remoteSubnets)
	if err != nil {
		return err
	}
...
func (ovn *SyncHandler) updateSubmarinerRouterLocalRoutes() error {
	...
	err := ovn.reconcileSubOvnLogicalRouterStaticRoutes(submarinerDownstreamRPort, ovnClusterSubmarinerIP, localSubnets)
	if err != nil {
		return err
	}
